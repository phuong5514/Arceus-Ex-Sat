...
Từ màn hình chính, nhấp vào `Chuyển đến Giáo vu5` ở góc trên bên trái để đến giao diện của giái vụ.
Các chức năng của giáo vụ bao gồm:
...
+ Xem thông tin học tập, danh sách các học phần sinh đã đăng ký và có thể đăng ký
